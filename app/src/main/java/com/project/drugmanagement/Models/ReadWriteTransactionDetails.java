...
public class ReadWriteTransactionDetails {
    ...
    public ReadWriteTransactionDetails(String depoName, String invoiceNo, String invoiceDate, String productName, String mfgDate, String batch, String quantity, String pack, int total) {
